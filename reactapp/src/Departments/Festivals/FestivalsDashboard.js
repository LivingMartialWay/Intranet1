...
*/
import { DashboardHeader, DashboardMainInfo } from "./FestivalsHeader";
import { DashboardSideNavigation } from "./FestivalsSideNav"
    ...
    return (
        <HelpPanelProvider value={handleToolsContentChange}>
            <AppLayout
                ...
                breadcrumbs={
                    <Breadcrumbs items={[{ text: "Festivals", href: "#/" }]} />
                }
