...
*/
import { DashboardHeader, DashboardMainInfo } from "./MarketingHeader";
import { DashboardSideNavigation } from "./MarketingSideNav"
    ...
    return (
        <HelpPanelProvider value={handleToolsContentChange}>
            <AppLayout
                ...
                breadcrumbs={
                    <Breadcrumbs items={[{ text: "Marketing", href: "#/" }]} />
                }
