...
*/
import { DashboardHeader, DashboardMainInfo } from "./AccountingHeader";
import { DashboardSideNavigation } from "./AccountingSideNav"
    ...
    return (
        <HelpPanelProvider value={handleToolsContentChange}>
            <AppLayout
                ...
                breadcrumbs={
                    <Breadcrumbs items={[{ text: "Accounting", href: "#/" }]} />
                }
