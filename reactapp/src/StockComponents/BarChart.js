            ...
            series={[
                {
                    ...
                    type: "bar",
                    data: [
                        { x: new Date(1601096400000), y: 34503 },
                        { x: new Date(1601103600000), y: 25832 },
                        { x: new Date(1601110800000), y: 4012 },
                        { x: new Date(1601118000000), y: -5602 },
                        { x: new Date(1601125200000), y: 17839 }
                    ],
                    valueFormatter: e =>
